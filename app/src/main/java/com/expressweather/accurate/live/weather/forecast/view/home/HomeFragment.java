...
import com.expressweather.accurate.live.weather.forecast.utils.eventbus.EventBusHelper;
...
public class HomeFragment extends BaseFragment<FragmentHomeBinding> {
    ...
    public void onMessageEvent(UpdateEvent event) {
        ...
        if (ConsentHelper.getInstance(requireContext()).canRequestAds()){
            loadNative();
        }
    }
    @Override
    ...
    private void setTimeWeatherList(ArrayList<Hourly> weatherList, String latitude, String longitude) {
        ArrayList<WeatherByHour> listWeatherByHour = new ArrayList<>();

        for (int i = 0; i < weatherList.size(); i++) {
            Hourly hourly = weatherList.get(i);
            Hourly hourlyNext;

            if (i + 1 == weatherList.size()) {
                hourlyNext = weatherList.get(0);
            } else {
                hourlyNext = weatherList.get(i + 1);
            }
        ...
        linearLayoutManager = new LinearLayoutManager(requireActivity(), RecyclerView.HORIZONTAL, false);
        ...
        timezoneCall.enqueue(new Callback<TimeZoneModel>() {
            ...
            public void onResponse(@NonNull Call<TimeZoneModel> call, @NonNull Response<TimeZoneModel> response) {
                if (response.body() != null) {
                    ...
                    setPref(requireContext(), Constants.GET_API_TIMEZONE_FIRST, true);
                } else {
    ...
    private void pushDataIntoView(TimeZoneModel response) {
        setPref(requireContext(), Constants.TIME_ZONE_REAL_LOCAL, new Gson().toJson(response));
    ...
    private TimeZoneModel getTimeZoneFake() {
        TimeZoneModel timeZoneModel = new TimeZoneModel();
        if (getContext() != null) {
            String timeZoneRealLocal = getPref(getContext(), Constants.TIME_ZONE_REAL_LOCAL, Constants.TIME_ZONE_FAKE);
            try {
                Type typeOfObjectsList = new TypeToken<TimeZoneModel>() {}.getType();
                if (!getPref(getContext(), Constants.GET_API_TIMEZONE_FIRST, false)) {
    ...
    private void setDataWeather(RootModel dataWeather) {
        ...
        ArrayList<Hourly> hourlyWeatherList = null;
        String precipitationMM = null;
        String humidity = null;
        String visibility = null;
        int tempC = 0, temFeelC = 0;

        if (dataWeather != null && dataWeather.current_condition != null) {
            //data for today
            CurrentCondition currentCondition = new CurrentCondition();
            if (dataWeather.current_condition.get(0) != null) {
                currentCondition = dataWeather.current_condition.get(0);
            }
            ...
            if (temperature != null) {
                ...
                binding.tvTemperature.setText("25");
            }
            ...
            if (weatherString != null) {
                ...
                binding.tvWeather.setText("Party cloudy");
                binding.imgIconWeather.setImageDrawable(ContextCompat.getDrawable(requireContext(), R.drawable.ic_snow_fall));
                binding.imgWeatherBg.setImageResource(WeatherState.gifWeather);
            }
            ...
            if (uvIndex != null) {
                ...
                binding.layoutInfo.tvUvIndexValue.setText("4");
                binding.layoutInfo.tvUVDescription.setText("Moderate");
            }
            ...
            if (astronomy != null) {
                ...
                binding.layoutInfo.tvSunRiseTime.setText("05:57 AM");
                binding.layoutInfo.tvSunSetTime.setText("Sunset: 7:25 PM");
            }
            ...
            if (windSpeedKmph != null) {
                ...
                binding.layoutInfo.tvWindValue.setText("2");
                binding.layoutInfo.tvUnitWS.setText("km/h");
            }

            //feels like
            if (temperatureFeel != null) {
                ...
                binding.layoutInfo.tvFLTempValue.setText("19\u00B0");
                binding.layoutInfo.tvFLDescription.setText(getString(R.string.similar_to_the_actual_temperature));
            }
            ...
            if (pressureValue != null) {
                ...
                binding.layoutInfo.tvPressureValue.setText("1");
                binding.layoutInfo.tvUnitPressure.setText("hPa");
            }
            ...
            if (weather != null) {
                ...
                binding.tvHighest.setText("H:" + "33" + "°");
                binding.tvLowest.setText("L:" + "24" + "°");
            }
            ...
            if (precipitationMM != null) {
                ...
                binding.layoutInfo.tvRainFallValue.setText("5");
                binding.layoutInfo.tvUnitRainFall.setText("mm");
            }
            ...
            if (humidity != null) {
                ...
                binding.layoutInfo.tvHumidityPercent.setText("100%");
            }
            ...
            if (visibility != null) {
                ...
                binding.layoutInfo.tvVisibilityValue.setText("2");
                binding.layoutInfo.tvUnitVisibility.setText("km");
            }
            ...
            if (temperature != null) {
                ...
                binding.tvTemperatureCollapse.setText("25" + "°");
                binding.imgWeatherCollapse.setImageDrawable(ContextCompat.getDrawable(requireContext(), R.drawable.ic_snow_fall));
                binding.tvWeatherCollapse.setText("25" + "°");
            }
        }
    }
    ...
    private void rateHandle() {
        rateDialog = new RateDialog(requireActivity());
        thankYouDialog = new ThankYouDialog(requireActivity());
        rateDialog.addOnRateListener(new RateDialog.OnRateDialogPress() {
            ...
            public void send() {
                ...
                //set drawer layout
                ((MainActivity) requireActivity()).initGeneralItem();
            }
            ...
            public void rating() {
                ...
                request.addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Task<Void> voidTask = manager.launchReviewFlow(requireActivity(), reviewInfo);
    ...
    private void loadNative() {
        if (isNetworkAvailable(requireActivity())) {
            try {
                Admob.getInstance().loadNativeAd(requireActivity(), getString(R.string.native_home), new NativeCallback(){
                    @Override
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        super.onNativeAdLoaded(nativeAd);
                        NativeAdView adView = (NativeAdView) LayoutInflater.from(requireActivity()).inflate(R.layout.native_ads_small_below_button, null);
